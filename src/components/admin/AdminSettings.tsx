    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end gap-3">
        <button
          ...
          className="px-6 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium transition"
        >
          Reset
        </button>
        <button
      ...
      <div className="bg-red-50 rounded-lg shadow-sm border border-red-200 p-6">
        ...
        <button className="mt-4 px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 font-medium transition">
          Clear All Cache
        </button>
      </div>
    </div>
